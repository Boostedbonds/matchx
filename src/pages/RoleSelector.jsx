    ...
    <div style={{ minHeight: "100vh", background: t.bg, overflowY: "auto", position: "relative" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .theme-toggle:hover { border-color: ${dark ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.2)"}; color: ${dark ? "#fff" : "#000"}; }
        ...
        .rs-divider-text {
          ...
          letter-spacing: 3px; text-transform: uppercase; color: ${t.dividerText};
          white-space: nowrap;
        }
      ...
      <div className={`rs-page ${loaded ? "loaded" : ""}`}>
        ...
        <div className="rs-cards">
          ...
          {/* SPECTATOR */}
          <div className="rs-card spectator">
            <div className="rs-card-top">
              <div className="rs-icon">👁</div>
