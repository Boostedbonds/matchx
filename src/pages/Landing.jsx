...
function Landing() {
  ...
  return (
    <div className="landing-container">
      ...
      {/* Racket SVG background - Full page */}
      <svg 
      ...
      >
        ...
        {/* Racket neck */}
        <path 
          d="M 220 475 Q 215 510 226 535 L 274 535 Q 285 510 280 475 Z" 
          fill="none" 
        ...
        {/* Handle grip area */}
        <path 
          d="M 218 720 Q 214 740 216 780 L 284 780 Q 286 740 282 720 Z" 
          fill="url(#goldHandle)" 
          opacity="0.85"
          filter="url(#glow)"
        />
