  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080a0f", color: "#fff", display: "flex" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .main {
          ...
          padding: 32px; overflow-y: auto; min-height: 100vh;
        }
        ...
        .live-badge {
          ...
          letter-spacing: 3px; color: #ff3250; text-transform: uppercase;
        }
        ...
        .stat-card::before {
          ...
          width: 3px; height: 100%; background: var(--accent, #00ffc8);
        }
        ...
        .action-btn:hover {
          background: rgba(0,255,200,0.06); border-color: rgba(0,255,200,0.25);
        ...
        .status-dot { position: absolute; bottom: 0; right: 0; width: 9px; height: 9px; border-radius: 50%; border: 2px solid #0d0f15; }
        ...
        .challenge-btn {
          padding: 5px 12px; background: rgba(0,255,200,0.08);
          border: 1px solid rgba(0,255,200,0.2); color: #00ffc8; cursor: pointer;
      ...
      <div className="main">
        ...
        {/* Live match watch banner — shown when a match is active */}
        {liveMatch && (
        ...
        <div className="stats-grid">
          <div className="stat-card" style={{ "--accent": "#00ffc8" }}>
            ...
            <div className="win-rate-bar"><div className="win-rate-fill" style={{ width: `${user?.winRate || 0}%` }} /></div>
          </div>
            ...
            <div className="card">
              ...
              <div className="quick-actions">
                {[
                  ...
                  { icon: "📡", label: "Watch Live", nav: null },
            ...
            <div className="card">
              ...
              {ONLINE_PLAYERS.slice(0, 4).map((p, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 0", borderBottom: i < 3 ? "1px solid rgba(255,255,255,0.04)" : "none" }}>
                  ...
                  <div className="op-avatar" style={{ width: 30, height: 30, fontSize: 11 }}>
                    {p.init}
                    <div className={`status-dot ${p.playing ? "playing" : p.status}`} />
                  </div>
                  <div style={{ flex: 1 }}>
            ...
            <div className="card" style={{ background: "linear-gradient(135deg, rgba(0,255,200,0.06), rgba(0,136,255,0.06))", border: "1px solid rgba(0,255,200,0.15)" }}>
              ...
              <div style={{ textAlign: "center", padding: "8px 0" }}>
                ...
                <div style={{ height: 6, background: "rgba(255,255,255,0.06)", borderRadius: 3, overflow: "hidden" }}>
                  <div style={{ height: "100%", width: `${Math.min(100, ((user?.points || 0) / 5000) * 100)}%`, background: "linear-gradient(90deg,#00ffc8,#0088ff)", borderRadius: 3, transition: "width 1s ease" }} />
                </div>
                <div style={{ fontFamily: "'Rajdhani'", fontSize: 11, color: "#00ffc8", marginTop: 6, letterSpacing: 1 }}>
                  {(user?.points || 0).toLocaleString()} / 5,000 pts
                </div>
              </div>
            </div>
          </div>
