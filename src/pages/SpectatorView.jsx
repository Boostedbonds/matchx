            ...
            <div className="stream-card">
              ...
              {cameraError && (
                <div className="camera-error">
                  ⚠️ Camera access denied — please allow camera permissions and try again
                </div>
              )}

              <div className="stream-controls">
                {!streaming ? (
                  <button className="stream-btn start" onClick={startStream}>
                    📡 Start Streaming
                  </button>
                ) : (
                  <button className="stream-btn stop" onClick={stopStream}>
                    ⏹ Stop Stream
                  </button>
                )}
              </div>
